...
#define _tmp_22_type 1182
#define _loop1_23_type 1183
#define _tmp_24_type 1184
#define _tmp_25_type 1185
#define _loop0_27_type 1186
#define _gather_26_type 1187
#define _loop0_29_type 1188
#define _gather_28_type 1189
#define _tmp_30_type 1190
#define _tmp_31_type 1191
#define _loop0_32_type 1192
#define _loop1_33_type 1193
#define _loop0_35_type 1194
#define _gather_34_type 1195
#define _tmp_36_type 1196
#define _loop0_38_type 1197
#define _gather_37_type 1198
#define _tmp_39_type 1199
#define _loop0_41_type 1200
#define _gather_40_type 1201
#define _loop0_43_type 1202
#define _gather_42_type 1203
#define _loop0_45_type 1204
#define _gather_44_type 1205
#define _loop0_47_type 1206
#define _gather_46_type 1207
#define _tmp_48_type 1208
#define _loop1_49_type 1209
#define _tmp_50_type 1210
#define _tmp_51_type 1211
#define _tmp_52_type 1212
#define _tmp_53_type 1213
#define _tmp_54_type 1214
#define _loop0_55_type 1215
#define _loop0_56_type 1216
#define _loop0_57_type 1217
#define _loop1_58_type 1218
#define _loop0_59_type 1219
#define _loop1_60_type 1220
#define _loop1_61_type 1221
#define _loop1_62_type 1222
#define _loop0_63_type 1223
#define _loop1_64_type 1224
#define _loop0_65_type 1225
#define _loop1_66_type 1226
#define _loop0_67_type 1227
#define _loop1_68_type 1228
#define _loop1_69_type 1229
#define _tmp_70_type 1230
#define _loop0_72_type 1231
#define _gather_71_type 1232
#define _loop1_73_type 1233
#define _loop0_75_type 1234
#define _gather_74_type 1235
#define _loop1_76_type 1236
#define _loop0_77_type 1237
#define _loop0_78_type 1238
#define _loop0_79_type 1239
#define _loop1_80_type 1240
#define _loop0_81_type 1241
#define _loop1_82_type 1242
#define _loop1_83_type 1243
#define _loop1_84_type 1244
#define _loop0_85_type 1245
#define _loop1_86_type 1246
#define _loop0_87_type 1247
#define _loop1_88_type 1248
#define _loop0_89_type 1249
#define _loop1_90_type 1250
#define _loop1_91_type 1251
#define _loop1_92_type 1252
#define _loop1_93_type 1253
...
static asdl_seq *_loop1_23_rule(Parser *p);
...
small_stmt_rule(Parser *p)
{
    ...
    { // ('pass' | 'coffeecat')
        ...
        D(fprintf(stderr, "%*c> small_stmt[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "('pass' | 'coffeecat')"));
        void *_tmp_15_var;
        if (
            (_tmp_15_var = _tmp_15_rule(p))  // 'pass' | 'coffeecat'
        )
        {
            D(fprintf(stderr, "%*c+ small_stmt[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "('pass' | 'coffeecat')"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s small_stmt[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "('pass' | 'coffeecat')"));
    }
    { // &'del' del_stmt
        if (p->error_indicator) {
            D(p->level--);
        ...
        if (
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 502)  // token='del'
            &&
    ...
    { // &'yield' yield_stmt
        ...
        if (
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 503)  // token='yield'
            &&
    ...
    { // &'assert' assert_stmt
        ...
        if (
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 504)  // token='assert'
            &&
    ...
    { // 'break'
        ...
        Token * _keyword;
        if (
            (_keyword = _PyPegen_expect_token(p, 505))  // token='break'
        )
        {
            D(fprintf(stderr, "%*c+ small_stmt[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'break'"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
    ...
    { // 'continue'
        ...
        Token * _keyword;
        if (
            (_keyword = _PyPegen_expect_token(p, 506))  // token='continue'
        )
        {
            D(fprintf(stderr, "%*c+ small_stmt[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'continue'"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
    ...
    { // &'global' global_stmt
        ...
        if (
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 507)  // token='global'
            &&
    ...
    { // &'nonlocal' nonlocal_stmt
        ...
        if (
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 508)  // token='nonlocal'
            &&
...
compound_stmt_rule(Parser *p)
{
    ...
    { // &'if' if_stmt
        ...
        stmt_ty if_stmt_var;
        if (
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 509)  // token='if'
            &&
    ...
    { // &'try' try_stmt
        ...
        if (
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 510)  // token='try'
            &&
    ...
    { // &'while' while_stmt
        ...
        if (
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 511)  // token='while'
            &&
...
assignment_rule(Parser *p)
{
    ...
    { // NAME ':' expression ['=' annotated_rhs]
        ...
        if (
            ...
            (b = expression_rule(p))  // expression
            &&
            (c = _tmp_20_rule(p), 1)  // ['=' annotated_rhs]
        )
        {
    ...
    { // ('(' single_target ')' | single_subscript_attribute_target) ':' expression ['=' annotated_rhs]
        ...
        void *c;
        if (
            (a = _tmp_21_rule(p))  // '(' single_target ')' | single_subscript_attribute_target
            &&
            (_literal = _PyPegen_expect_token(p, 11))  // token=':'
            &&
            (b = expression_rule(p))  // expression
            &&
            (c = _tmp_22_rule(p), 1)  // ['=' annotated_rhs]
        )
        {
            D(fprintf(stderr, "%*c+ assignment[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "('(' single_target ')' | single_subscript_attribute_target) ':' expression ['=' annotated_rhs]"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
    ...
    { // ((star_targets '='))+ (yield_expr | star_expressions) !'=' TYPE_COMMENT?
        ...
        void *tc;
        if (
            (a = _loop1_23_rule(p))  // ((star_targets '='))+
            &&
            (b = _tmp_24_rule(p))  // yield_expr | star_expressions
            &&
    ...
    { // single_target augassign ~ (yield_expr | star_expressions)
        ...
        if (
            ...
            (_cut_var = 1)
            &&
            (c = _tmp_25_rule(p))  // yield_expr | star_expressions
        )
        {
            D(fprintf(stderr, "%*c+ assignment[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "single_target augassign ~ (yield_expr | star_expressions)"));
            Token *_token = _PyPegen_get_last_nonnwhitespace_token(p);
...
global_stmt_rule(Parser *p)
{
    ...
    { // 'global' ','.NAME+
        ...
        asdl_seq * a;
        if (
            (_keyword = _PyPegen_expect_token(p, 507))  // token='global'
            &&
            (a = _gather_26_rule(p))  // ','.NAME+
        )
        {
...
nonlocal_stmt_rule(Parser *p)
{
    ...
    { // 'nonlocal' ','.NAME+
        ...
        asdl_seq * a;
        if (
            (_keyword = _PyPegen_expect_token(p, 508))  // token='nonlocal'
            &&
            (a = _gather_28_rule(p))  // ','.NAME+
        )
        {
...
assert_stmt_rule(Parser *p)
{
    ...
    { // 'assert' expression [',' expression]
        ...
        void *b;
        if (
            (_keyword = _PyPegen_expect_token(p, 504))  // token='assert'
            &&
            (a = expression_rule(p))  // expression
            &&
            (b = _tmp_30_rule(p), 1)  // [',' expression]
        )
        {
...
del_stmt_rule(Parser *p)
{
    ...
    { // 'del' del_targets &(';' | NEWLINE)
        ...
        asdl_seq* a;
        if (
            (_keyword = _PyPegen_expect_token(p, 502))  // token='del'
            &&
            (a = del_targets_rule(p))  // del_targets
            &&
            _PyPegen_lookahead(1, _tmp_31_rule, p)
        )
        {
...
import_name_rule(Parser *p)
{
    ...
    { // 'import' dotted_as_names
        ...
        asdl_seq* a;
        if (
            (_keyword = _PyPegen_expect_token(p, 512))  // token='import'
            &&
...
import_from_rule(Parser *p)
{
    ...
    { // 'from' (('.' | '...'))* dotted_name 'import' import_from_targets
        ...
        asdl_seq* c;
        if (
            (_keyword = _PyPegen_expect_token(p, 513))  // token='from'
            &&
            (a = _loop0_32_rule(p))  // (('.' | '...'))*
            &&
            (b = dotted_name_rule(p))  // dotted_name
            &&
            (_keyword_1 = _PyPegen_expect_token(p, 512))  // token='import'
            &&
...
import_from_as_names_rule(Parser *p)
{
    ...
    { // ','.import_from_as_name+
        ...
        asdl_seq * a;
        if (
            (a = _gather_34_rule(p))  // ','.import_from_as_name+
        )
        {
...
dotted_as_names_rule(Parser *p)
{
    ...
    { // ','.dotted_as_name+
        ...
        asdl_seq * a;
        if (
            (a = _gather_37_rule(p))  // ','.dotted_as_name+
        )
        {
...
if_stmt_rule(Parser *p)
{
    ...
    { // 'if' named_expression ':' block elif_stmt
        ...
        stmt_ty c;
        if (
            (_keyword = _PyPegen_expect_token(p, 509))  // token='if'
            &&
...
elif_stmt_rule(Parser *p)
{
    ...
    { // 'elif' named_expression ':' block elif_stmt
        ...
        stmt_ty c;
        if (
            (_keyword = _PyPegen_expect_token(p, 514))  // token='elif'
            &&
            (a = named_expression_rule(p))  // named_expression
            &&
            (_literal = _PyPegen_expect_token(p, 11))  // token=':'
...
while_stmt_rule(Parser *p)
{
    ...
    { // 'while' named_expression ':' block else_block?
        ...
        void *c;
        if (
            (_keyword = _PyPegen_expect_token(p, 511))  // token='while'
            &&
            (a = named_expression_rule(p))  // named_expression
            &&
            (_literal = _PyPegen_expect_token(p, 11))  // token=':'
...
for_stmt_rule(Parser *p)
{
    ...
    { // 'for' star_targets 'in' ~ star_expressions ':' TYPE_COMMENT? block else_block?
        ...
        void *tc;
        if (
            (_keyword = _PyPegen_expect_token(p, 516))  // token='for'
            &&
            (t = star_targets_rule(p))  // star_targets
            &&
            (_keyword_1 = _PyPegen_expect_token(p, 517))  // token='in'
            &&
            (_cut_var = 1)
            &&
...
with_stmt_rule(Parser *p)
{
    ...
    { // 'with' '(' ','.with_item+ ','? ')' ':' block
        ...
        asdl_seq* b;
        if (
            (_keyword = _PyPegen_expect_token(p, 518))  // token='with'
            &&
            (_literal = _PyPegen_expect_token(p, 7))  // token='('
            &&
...
with_item_rule(Parser *p)
{
    ...
    { // expression 'as' target &(',' | ')' | ':')
        ...
        if (
            ...
            &&
            (_keyword = _PyPegen_expect_token(p, 519))  // token='as'
            &&
            (t = target_rule(p))  // target
            &&
            _PyPegen_lookahead(1, _tmp_48_rule, p)
        )
        {
...
try_stmt_rule(Parser *p)
{
    ...
    { // 'try' ':' block finally_block
        ...
        asdl_seq* f;
        if (
            (_keyword = _PyPegen_expect_token(p, 510))  // token='try'
            &&
            (_literal = _PyPegen_expect_token(p, 11))  // token=':'
            &&
            (b = block_rule(p))  // block
    ...
    { // 'try' ':' block except_block+ else_block? finally_block?
        ...
        if (
            ...
            (b = block_rule(p))  // block
            &&
            (ex = _loop1_49_rule(p))  // except_block+
            &&
            (el = else_block_rule(p), 1)  // else_block?
            &&
...
raise_stmt_rule(Parser *p)
{
    ...
    { // 'raise' expression ['from' expression]
        ...
        if (
            ...
            (a = expression_rule(p))  // expression
            &&
            (b = _tmp_51_rule(p), 1)  // ['from' expression]
        )
        {
...
parameters_rule(Parser *p)
{
    ...
    { // slash_no_default param_no_default* param_with_default* star_etc?
        ...
        if (
            ...
            &&
            (b = _loop0_55_rule(p))  // param_no_default*
            &&
            (c = _loop0_56_rule(p))  // param_with_default*
            &&
    ...
    { // param_no_default+ param_with_default* star_etc?
        ...
        void *c;
        if (
            (a = _loop1_58_rule(p))  // param_no_default+
            &&
            (b = _loop0_59_rule(p))  // param_with_default*
            &&
            (c = star_etc_rule(p), 1)  // star_etc?
        )
        {
    ...
    { // param_with_default+ star_etc?
        ...
        void *b;
        if (
            (a = _loop1_60_rule(p))  // param_with_default+
            &&
...
slash_no_default_rule(Parser *p)
{
    ...
    { // param_no_default+ '/' &')'
        ...
        asdl_seq * a;
        if (
            (a = _loop1_62_rule(p))  // param_no_default+
            &&
            (_literal = _PyPegen_expect_token(p, 17))  // token='/'
            &&
...
slash_with_default_rule(Parser *p)
{
    ...
    { // param_no_default* param_with_default+ '/' &')'
        ...
        asdl_seq * b;
        if (
            (a = _loop0_65_rule(p))  // param_no_default*
            &&
            (b = _loop1_66_rule(p))  // param_with_default+
            &&
            (_literal = _PyPegen_expect_token(p, 17))  // token='/'
            &&
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 8)  // token=')'
...
star_etc_rule(Parser *p)
{
    ...
    { // '*' param_no_default param_maybe_default* kwds?
        ...
        if (
            ...
            &&
            (b = _loop0_67_rule(p))  // param_maybe_default*
            &&
    ...
    { // '*' ',' param_maybe_default+ kwds?
        ...
        if (
            ...
            (_literal_1 = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (b = _loop1_68_rule(p))  // param_maybe_default+
            &&
            (c = kwds_rule(p), 1)  // kwds?
        )
        {
...
decorators_rule(Parser *p)
{
    ...
    { // (('@' named_expression NEWLINE))+
        ...
        asdl_seq * a;
        if (
            (a = _loop1_69_rule(p))  // (('@' named_expression NEWLINE))+
        )
        {
...
expressions_list_rule(Parser *p)
{
    ...
    { // ','.star_expression+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_71_rule(p))  // ','.star_expression+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
star_expressions_rule(Parser *p)
{
    ...
    { // star_expression ((',' star_expression))+ ','?
        ...
        if (
            ...
            &&
            (b = _loop1_73_rule(p))  // ((',' star_expression))+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
star_named_expressions_rule(Parser *p)
{
    ...
    { // ','.star_named_expression+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_74_rule(p))  // ','.star_named_expression+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
expression_rule(Parser *p)
{
    ...
    { // disjunction 'if' disjunction 'else' expression
        ...
        if (
            ...
            &&
            (_keyword_1 = _PyPegen_expect_token(p, 515))  // token='else'
            &&
            (c = expression_rule(p))  // expression
        )
        {
...
lambda_parameters_rule(Parser *p)
{
    ...
    { // lambda_slash_no_default lambda_param_no_default* lambda_param_with_default* lambda_star_etc?
        ...
        if (
            ...
            &&
            (b = _loop0_77_rule(p))  // lambda_param_no_default*
            &&
            (c = _loop0_78_rule(p))  // lambda_param_with_default*
            &&
    ...
    { // lambda_param_no_default+ lambda_param_with_default* lambda_star_etc?
        ...
        if (
            ...
            &&
            (b = _loop0_81_rule(p))  // lambda_param_with_default*
            &&
            (c = lambda_star_etc_rule(p), 1)  // lambda_star_etc?
        )
        {
    ...
    { // lambda_param_with_default+ lambda_star_etc?
        ...
        void *b;
        if (
            (a = _loop1_82_rule(p))  // lambda_param_with_default+
            &&
...
lambda_slash_no_default_rule(Parser *p)
{
    ...
    { // lambda_param_no_default+ '/' &':'
        ...
        asdl_seq * a;
        if (
            (a = _loop1_84_rule(p))  // lambda_param_no_default+
            &&
            (_literal = _PyPegen_expect_token(p, 17))  // token='/'
            &&
...
lambda_slash_with_default_rule(Parser *p)
{
    ...
    { // lambda_param_no_default* lambda_param_with_default+ '/' &':'
        ...
        asdl_seq * b;
        if (
            (a = _loop0_87_rule(p))  // lambda_param_no_default*
            &&
            (b = _loop1_88_rule(p))  // lambda_param_with_default+
            &&
            (_literal = _PyPegen_expect_token(p, 17))  // token='/'
            &&
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 11)  // token=':'
...
lambda_star_etc_rule(Parser *p)
{
    ...
    { // '*' lambda_param_no_default lambda_param_maybe_default* lambda_kwds?
        ...
        if (
            ...
            &&
            (b = _loop0_89_rule(p))  // lambda_param_maybe_default*
            &&
    ...
    { // '*' ',' lambda_param_maybe_default+ lambda_kwds?
        ...
        if (
            ...
            (_literal_1 = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (b = _loop1_90_rule(p))  // lambda_param_maybe_default+
            &&
            (c = lambda_kwds_rule(p), 1)  // lambda_kwds?
        )
        {
...
disjunction_rule(Parser *p)
{
    ...
    { // conjunction (('or' conjunction))+
        ...
        if (
            ...
            &&
            (b = _loop1_91_rule(p))  // (('or' conjunction))+
        )
        {
...
conjunction_rule(Parser *p)
{
    ...
    { // inversion (('and' inversion))+
        ...
        if (
            ...
            &&
            (b = _loop1_92_rule(p))  // (('and' inversion))+
        )
        {
...
comparison_rule(Parser *p)
{
    ...
    { // bitwise_or compare_op_bitwise_or_pair+
        ...
        if (
            (a = bitwise_or_rule(p))  // bitwise_or
            &&
            (b = _loop1_93_rule(p))  // compare_op_bitwise_or_pair+
        )
        {
...
in_bitwise_or_rule(Parser *p)
{
    ...
    { // 'in' bitwise_or
        ...
        expr_ty a;
        if (
            (_keyword = _PyPegen_expect_token(p, 517))  // token='in'
            &&
            (a = bitwise_or_rule(p))  // bitwise_or
        )
        {
...
for_if_clauses_rule(Parser *p)
{
    ...
    { // for_if_clause+
        ...
        asdl_seq * _loop1_106_var;
        if (
            (_loop1_106_var = _loop1_106_rule(p))  // for_if_clause+
        )
        {
...
for_if_clause_rule(Parser *p)
{
    ...
    { // 'for' star_targets 'in' ~ disjunction (('if' disjunction))*
        ...
        if (
            ...
            (b = disjunction_rule(p))  // disjunction
            &&
            (c = _loop0_108_rule(p))  // (('if' disjunction))*
        )
        {
            D(fprintf(stderr, "%*c+ for_if_clause[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'for' star_targets 'in' ~ disjunction (('if' disjunction))*"));
...
yield_expr_rule(Parser *p)
{
    ...
    { // 'yield' 'from' expression
        ...
        expr_ty a;
        if (
            (_keyword = _PyPegen_expect_token(p, 503))  // token='yield'
            &&
            (_keyword_1 = _PyPegen_expect_token(p, 513))  // token='from'
            &&
            (a = expression_rule(p))  // expression
        )
        {
...
args_rule(Parser *p)
{
    ...
    { // ','.(starred_expression | named_expression !'=')+ [',' kwargs]
        ...
        void *b;
        if (
            (a = _gather_109_rule(p))  // ','.(starred_expression | named_expression !'=')+
            &&
...
star_targets_seq_rule(Parser *p)
{
    ...
    { // ','.star_target+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_121_rule(p))  // ','.star_target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
del_targets_rule(Parser *p)
{
    ...
    { // ','.del_target+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_124_rule(p))  // ','.del_target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
_tmp_15_rule(Parser *p)
{
    ...
    { // 'coffeecat'
        ...
        D(fprintf(stderr, "%*c> _tmp_15[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "'coffeecat'"));
        Token * _keyword;
        if (
            (_keyword = _PyPegen_expect_token(p, 532))  // token='coffeecat'
        )
        {
            D(fprintf(stderr, "%*c+ _tmp_15[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'coffeecat'"));
            _res = _keyword;
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s _tmp_15[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "'coffeecat'"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _tmp_21: '(' single_target ')' | single_subscript_attribute_target
static void *
...
// _loop1_23: (star_targets '=')
static asdl_seq *
_loop1_23_rule(Parser *p)
{
    D(p->level++);
    if (p->error_indicator) {
        D(p->level--);
    ...
    { // (star_targets '=')
        ...
        D(fprintf(stderr, "%*c> _loop1_23[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "(star_targets '=')"));
        void *_tmp_140_var;
        while (
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s _loop1_23[%d-%d]: %s failed!\n", p->level, ' ',
    ...
    for (int i = 0; i < _n; i++) asdl_seq_SET(_seq, i, _children[i]);
    PyMem_Free(_children);
    _PyPegen_insert_memo(p, _start_mark, _loop1_23_type, _seq);
    D(p->level--);
    return _seq;
}
...
// _tmp_25: yield_expr | star_expressions
static void *
...
_gather_26_rule(Parser *p)
{
    ...
    { // NAME _loop0_27
        ...
        D(fprintf(stderr, "%*c> _gather_26[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "NAME _loop0_27"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = _PyPegen_name_token(p))  // NAME
        ...
        D(fprintf(stderr, "%*c%s _gather_26[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "NAME _loop0_27"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_loop0_29_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) asdl_seq_SET(_seq, i, _children[i]);
    PyMem_Free(_children);
    _PyPegen_insert_memo(p, _start_mark, _loop0_29_type, _seq);
    D(p->level--);
    return _seq;
}
...
_gather_28_rule(Parser *p)
{
    ...
    { // NAME _loop0_29
        ...
        D(fprintf(stderr, "%*c> _gather_28[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "NAME _loop0_29"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = _PyPegen_name_token(p))  // NAME
        ...
        {
            D(fprintf(stderr, "%*c+ _gather_28[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "NAME _loop0_29"));
            _res = _PyPegen_seq_insert_in_front(p, elem, seq);
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s _gather_28[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "NAME _loop0_29"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_loop1_33_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) asdl_seq_SET(_seq, i, _children[i]);
    PyMem_Free(_children);
    _PyPegen_insert_memo(p, _start_mark, _loop1_33_type, _seq);
    D(p->level--);
    return _seq;
}
...
_loop0_35_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) asdl_seq_SET(_seq, i, _children[i]);
    PyMem_Free(_children);
    _PyPegen_insert_memo(p, _start_mark, _loop0_35_type, _seq);
    D(p->level--);
    return _seq;
}
...
_gather_34_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // import_from_as_name _loop0_35
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_34[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "import_from_as_name _loop0_35"));
        alias_ty elem;
        asdl_seq * seq;
        if (
            (elem = import_from_as_name_rule(p))  // import_from_as_name
        ...
        D(fprintf(stderr, "%*c%s _gather_34[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "import_from_as_name _loop0_35"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_gather_37_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // dotted_as_name _loop0_38
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_37[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "dotted_as_name _loop0_38"));
        alias_ty elem;
        asdl_seq * seq;
        if (
            (elem = dotted_as_name_rule(p))  // dotted_as_name
            &&
            (seq = _loop0_38_rule(p))  // _loop0_38
        )
        {
        ...
        D(fprintf(stderr, "%*c%s _gather_37[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "dotted_as_name _loop0_38"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _gather_46: with_item _loop0_47
static asdl_seq *
_gather_46_rule(Parser *p)
{
    ...
    { // with_item _loop0_47
        ...
        D(fprintf(stderr, "%*c> _gather_46[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "with_item _loop0_47"));
        withitem_ty elem;
        asdl_seq * seq;
        if (
            (elem = with_item_rule(p))  // with_item
        ...
        D(fprintf(stderr, "%*c%s _gather_46[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "with_item _loop0_47"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_loop0_59_rule(Parser *p)
{
    ...
    for (int i = 0; i < _n; i++) asdl_seq_SET(_seq, i, _children[i]);
    PyMem_Free(_children);
    _PyPegen_insert_memo(p, _start_mark, _loop0_59_type, _seq);
    D(p->level--);
    return _seq;
}
...
// _loop1_69: ('@' named_expression NEWLINE)
static asdl_seq *
...
// _gather_71: star_expression _loop0_72
static asdl_seq *
_gather_71_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // star_expression _loop0_72
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_71[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "star_expression _loop0_72"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = star_expression_rule(p))  // star_expression
        ...
        D(fprintf(stderr, "%*c%s _gather_71[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "star_expression _loop0_72"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _loop0_75: ',' star_named_expression
static asdl_seq *
...
// _gather_74: star_named_expression _loop0_75
static asdl_seq *
_gather_74_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // star_named_expression _loop0_75
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_74[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "star_named_expression _loop0_75"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = star_named_expression_rule(p))  // star_named_expression
        ...
        D(fprintf(stderr, "%*c%s _gather_74[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "star_named_expression _loop0_75"));
    }
    _res = NULL;
  done:
    D(p->level--);
